...
const About = () => {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText("josephedidiong36@gmail.com");
        setHasCopy(true);
                ...
                <div className='col-span-1 xl:row-span-3'>
                    <div className='grid-container'>
                        ...
                        <div>
                            ...
                            <p className='grid-subtext'>With 5 years of experience, I have honed my skills in frontend and backend development,
                    ...
                    <div className='grid-container'>
                        ...
                        <div>
                            ...
                            <p className='grid-subtext'>
                                I specialize in Javascript/TypeScript with React and Next.js ecosystems.
                            </p>
                        </div>
                    </div>
                ...
                <div className='xl:col-span-2 xl:row-span-3'>
                    <div className='grid-container'>
                        ...
                        <div>
                            ...
                            <p className="grid-subtext">I love solving problems abd building things through code.
                    ...
                    <div className='grid-container'>
                        ...
                        <div className='space-y-2'>
                            ...
                            <div className='copy-container' onClick={handleCopy}>
                                <img src={hasCopy ? 'assets/tick.svg' : 'assets/copy.svg'}
                                     alt='copy'/>
                                <p className='lg:text-2xl md:text-xl font-medium
                                text-gray_gradient text-white'>josephedidiong36@gmail.com</p>
                            </div>
                        </div>
                    </div>
